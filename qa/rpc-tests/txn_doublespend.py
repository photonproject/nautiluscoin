...
class TxnMallTest(NautiluscoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 NAUT:
        ...
        # First: use raw transaction API to send 1210 NAUT to node1_address,
        # but don't broadcast:
        ...
        # Node0's balance should be starting balance, plus 50NAUT for another
        ...
        # Node0's total balance should be starting balance, plus 100NAUT for 
