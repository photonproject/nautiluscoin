...
After exiting, you'll get a warning that the install is keg-only, which means it wasn't symlinked to `/usr/local`.  You don't need it to link it to build nautiluscoin, but if you want to, here's how:
...
1. Clone the github tree to get the source code and go into the directory.
        ...
        git clone https://github.com/nautiluscoin/nautiluscoin.git
        cd nautiluscoin
...
4.  (Optional) You can also install nautiluscoind to your path:
...
4. Enter "nautiluscoin-qt" as project name, enter src/qt as location
