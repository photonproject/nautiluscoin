Download URL: https://sourceforge.net/projects/nautiluscoin/files/Nautiluscoin/nautiluscoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 NAUT fee schedule (users still pay 0.01 NAUT per kb, until next version)
