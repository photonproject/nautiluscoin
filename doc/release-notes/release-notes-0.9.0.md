Nautiluscoin Core version 0.9.0 is now available from:

  https://nautiluscoin.org/bin/0.9.0/
...
TX outputs, bloating nautiluscoin's UTXO database.
...
0.1mNAUT per kilobyte. During periods of heavy transaction volume, even this
...
- Drop the fee required to relay a transaction to 0.01mNAUT per kilobyte
