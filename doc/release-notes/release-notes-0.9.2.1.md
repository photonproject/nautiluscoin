Nautiluscoin Core version 0.9.2.1 is now available from:

  https://nautiluscoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 NAUT to 0.01 NAUT
...
- Fix "Start nautiluscoin on system login"
