Nautiluscoin Core version 0.9.4 is now available from:

  https://nautiluscoin.org/bin/0.9.4/
...
this update is incompatible with the Nautiluscoin system and could lead to consensus
forks.

Nautiluscoin Core released binaries from https://nautiluscoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~nautiluscoin/+archive/ubuntu/nautiluscoin
- A third-party or self-compiled Nautiluscoin Core

upgrade to Nautiluscoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
