// Copyright (c) 2012-2013 The Nautiluscoin Core developers
...
{
    BOOST_CHECK(TestSplitHost("www.nautiluscoin.org", "www.nautiluscoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.nautiluscoin.org]", "www.nautiluscoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.nautiluscoin.org:80", "www.nautiluscoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.nautiluscoin.org]:80", "www.nautiluscoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:11161", "127.0.0.1", 11161));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:11161", "127.0.0.1", 11161));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:11161", "::ffff:127.0.0.1", 11161));
    BOOST_CHECK(TestSplitHost("[::]:11161", "::", 11161));
    BOOST_CHECK(TestSplitHost("::11161", "::11161", -1));
    BOOST_CHECK(TestSplitHost(":11161", "", 11161));
    BOOST_CHECK(TestSplitHost("[]:11161", "", 11161));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:11161", "127.0.0.1:11161"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:11161", "[::]:11161"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
