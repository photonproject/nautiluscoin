...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CNautiluscoinAddress demoAddress = CNautiluscoinAddress(CTxDestination(demoPubkey.GetID()));
    Value retValue;
    ...
    CNautiluscoinAddress setaccountDemoAddress = CNautiluscoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    ...
    BOOST_CHECK(CNautiluscoinAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CNautiluscoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
}
