...
void setupAddressWidget(QValidatedLineEdit *widget, QWidget *parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a Nautiluscoin address (e.g. %1)").arg("NNS17iag9jJgTHD1VXjvLCEnZuQ3rJDE9L"));
#endif
...
QString formatNautiluscoinURI(const SendCoinsRecipient &info)
{
    ...
    if (info.amount)
    {
        ret += QString("?amount=%1").arg(NautiluscoinUnits::format(NautiluscoinUnits::NAUT, info.amount, false, NautiluscoinUnits::separatorNever));
        paramCount++;
    }
