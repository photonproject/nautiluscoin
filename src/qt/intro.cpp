...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Nautiluscoin Core"),
     ...
     * override -datadir in the nautiluscoin.conf file in the default data directory
     * (to be consistent with nautiluscoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
