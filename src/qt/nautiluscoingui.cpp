...
NautiluscoinGUI::NautiluscoinGUI(const NetworkStyle *networkStyle, QWidget *parent) :
    QMainWindow(parent),
    clientModel(0),
    walletFrame(0),
...
void NautiluscoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Nautiluscoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Nautiluscoin Core"));
...
void NautiluscoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
#ifndef Q_OS_MAC
    trayIcon = new QSystemTrayIcon(this);
    QString toolTip = tr("Nautiluscoin Core client") + " " + networkStyle->getTitleAddText();
...
void NautiluscoinGUI::setNumBlocks(int count)
{
    if(!clientModel)
        return;
...
#ifdef ENABLE_WALLET
void NautiluscoinGUI::incomingTransaction(const QString& date, int unit, const CAmount& amount, const QString& type, const QString& address)
{
...
void NautiluscoinGUI::showProgress(const QString &title, int nProgress)
{
    if (nProgress == 0)
    {
...
void UnitDisplayStatusBarControl::createContextMenu()
{
    ...
    {
        QAction *menuAction = new QAction(QString(NautiluscoinUnits::name(u)), this);
...
{
    setPixmap(QIcon(":/icons/unit_" + NautiluscoinUnits::id(newUnits)).pixmap(31,STATUSBAR_ICONSIZE));
}
