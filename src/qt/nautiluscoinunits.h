...
#ifndef NAUTILUSCOIN_QT_NAUTILUSCOINUNITS_H
#define NAUTILUSCOIN_QT_NAUTILUSCOINUNITS_H
...
public:
    ...
    /** Nautiluscoin units.
      @note Source: https://en.nautiluscoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        NAUT,
...
#endif // NAUTILUSCOIN_QT_NAUTILUSCOINUNITS_H
