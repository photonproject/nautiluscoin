    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Nautiluscoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Nautiluscoin Core"));
        ...
        QString coreOptions = QString::fromStdString(HelpMessage(HMM_NAUTILUSCOIN_QT));
