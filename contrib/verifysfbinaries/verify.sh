...
###   This script attempts to download the signature file SHA256SUMS.asc from nautiluscoin.org
...
SIGNATUREFILE="https://nautiluscoin.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://nautiluscoin.org/bin/"
...
if [ $? -ne 0 ]; then
   ...
   echo "[nautiluscoin-]<version>-[rc[0-9]] (example: nautiluscoin-0.9.2-rc1)"
   echo "wget output:"
